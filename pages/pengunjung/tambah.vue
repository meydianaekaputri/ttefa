                ...
                <form>
                    ...
                    <div class="mb-3">
                        <select class="form-control form-control-lg form-select rounded-5">
                            ...
                            <option class="Siswa">Siswa</option>
                            <option class="Guru">Guru</option>
                            <option class="Staf">Staf</option>
                            <option class="Umum">Umum</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-md-4">
                                <select class="form-control form-controllg form-select rounded-5 mb-2">
                        ...
                        <nuxt-link to="../pengunjung">
                            <button type="submit" class="btn btn-lg rounded-5 px-5 bg-black text-white">KIRIM</button>
                        </nuxt-link>
                    </form>
                </div>
            </div>
